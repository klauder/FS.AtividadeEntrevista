$(document).ready(function () {
    ...
    $('#formCadastro').submit(function (e) {
        ...
        $.ajax({
            ...
            success:
            function (r) {
                //ModalDialog("Sucesso!", r) //Como vamos voltar a listagem de clientes não precisa mostrar a mensagem em caso de sucesso 
                //$("#formCadastro")[0].reset(); // Não precisa limpar o formulario, porque ao editar novos dados serão carregados
